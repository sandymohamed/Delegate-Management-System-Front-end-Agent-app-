...
import {
  Chip,
  Container, Divider, Grid2, IconButton, Link, MenuItem, Paper, Select, Stack,
  Table, TableBody, TableContainer, TableHead, TableRow, Typography
} from '@mui/material';
...
const CustomerInvoices = () => {
  ...
  return (
    <Container>
      <Paper sx={{ p: 2 }}>
        <Typography variant="h4" component="h3" gutterBottom>تفاصيل العميل : {customer?.name}</Typography>
